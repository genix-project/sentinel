...
class GenixDaemon():
    def __init__(self, **kwargs):
        ...
        # memoize calls to some genixd methods
    ...
    @classmethod
    def from_genix_conf(self, genix_dot_conf):
    ...
    def get_my_gobject_votes(self, object_hash):
        ...
        if not self.gobject_votes.get(object_hash):
            ...
            self.gobject_votes[object_hash] = genixlib.parse_raw_votes(raw_votes)
    ...
    def we_are_the_winner(self):
        ...
        winner = genixlib.elect_mn(block_hash=current_block_hash, mnlist=mn_list)
        my_vin = self.get_current_masternode_vin()
    ...
    def estimate_block_time(self, height):
        ...
        future_seconds = genixlib.blocks_to_seconds(diff)
