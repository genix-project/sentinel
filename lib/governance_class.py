...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to genixd "gobject list" output
    ...
    def genixd_serialise(self):
        import genixlib
        return genixlib.SHIM_serialise_for_genixd(self.serialise())
